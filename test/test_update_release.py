...
class TestUpdateRelease(TestCase):
    def test_update_table_column_subset(self):
        source_table_to_copy = "/home/gpoor/PycharmProjects/parse-cdd-html-to-source/a_working/9.9.3.tsv"
        subset_table_to_create = "/home/gpoor/PycharmProjects/parse-cdd-html-to-source/a_working/9.9.3_column_subset.tsv"
