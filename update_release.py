...
def update_release_table_with_changes():
    input_table, input_table_keys_to_index, input_header, duplicate_rows  = table_ops.read_table("input_sheet/2021-09-11-CDD-11-Sachiyo-Aug-4-restore.csv")
...
if __name__ == '__main__':
   ...
   # update_fullkey_table_with_only_new_changes()
    ...
    original_sheet_file_name="input/2021-09-11-CDD-11-Sachiyo-Aug-4-restore.csv"
    updated_output_file_name = 'output/release_updated_table2.csv'#'data_files/verify-dif.csv'
