...
class TestUpdate(TestCase):
    ...
    def test_filter_cdd_12_table_dict_by_keys(self, ):
        ...
        keys = ['7/C-0-5', '9.9.3.1/C-1-7', '7/C-0-1', '7.3.3/A-3-2', '7.1.5/H-0-1', '5.1.5/C-2-1', '9.9.3.1/C-1-9',
                ...
                '9.5/T-1-1']
        table_input = "/home/gpoor/PycharmProjects/parse-cdd-html-to-source/d1_working/CDD-12-only-req.tsv"
    ...
    def test_make_table_dict_by_keys(self, ):
        ...
        table_ops.write_table(
            "/d1_working/cdd_12_diff_11.tsv",
            new_table,
            header)
        self.assertIs(len(keys), len(new_table))

    def test_filter_by_table_files(self, ):
        table_out = "/home/gpoor/PycharmProjects/parse-cdd-html-to-source/d1_working/to_do_undone_subset.csv"
    ...
    def test_read_table_sect_and_req_key_no_req(self):
        input_table = "/home/gpoor/PycharmProjects/parse-cdd-html-to-source/d1_working/Working copy of CDD_CTS, CTS-V Annotation Tracker(8.1_9_10_11) go_cdd-cts-tracker - Undon.csv"
        table, key_fields, header, duplicate_rows = table_ops.read_table_sect_and_req_key(file_name=input_table,
                                                                                          logging=True)
        table_ops.write_table(
