...
class TestUpdate(TestCase):
    ...
    def test_filter_cdd_12_table_dict_by_keys(self, ):
        ...
        table_input = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/output/html_cdd_12_downloaded_2021_11_22.tsv"
        ...
        table_ops.write_table(
            "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/test/output/cdd_12_diff_11.tsv",
            new_table,
            header)
        self.assertIs(len(keys), len(new_table))

    cdd_11_html_file = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/input/cdd_11_download.html"
    cdd_11_table_created = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/input/cdd_11_table_created.tsv"  # So no filter
    cdd_12_html_file = "/cdd_12_download_2021_10_4.html"
    cdd_12_table_generated_from_html_all = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/input/cdd_12_full_table_from_html.tsv"
    cdd_12_table_created = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/input/cdd_12_table_all_1678.tsv"  # So no filter

    def test_make_table_current_released_11_to_see_if_we_have_really_done_90(self, ):

        table_input = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/data_files/CDD_11_CTS, CTS-V Annotation Tracker(8.1_9_10_11) go_cdd-cts-tracker - CDD 11_nov_2021_for_diff.tsv"
        table, key_fields, header, duplicate_rows = table_ops.read_table_sect_and_req_key(table_input)
        table_118, keys_fields_118, header_118, duplicate_rows_118 = table_ops.read_table_sect_and_req_key(
            "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/X_the_118_between_md12-11-a1_working_12/cdd_12_todo_created.tsv")
    ...
    def test_make_table_keys_in_11_but_not_in_12(self, ):
        keys = ['4/C-0-1', '4/C-0-8', '9.5/C-1-1', '4/C-0-4', '9.9.3.1/C-1-9', '4/C-0-9', '3.15/C-1-4',
                ...
                '9.9.3.2/C-1-2']
        cdd_11_table_generated_from_html_all = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/input/cdd_11_full_table_from_html.tsv"
    ...
    def test_make_table_dict_by_keys(self, ):
        ...
        cdd_12_table_generated_from_html_all = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/output/html_cdd_12_downloaded_2021_11_22.tsv"
    ...
    def test_filter_table_by_removing_keys(self, ):
        ...
        table_ops.write_table(
            "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/output/test_update_table_mapped_removed.csv",
            new_table, header)
    ...
    def test_filter_table_by_removing_keys2(self, ):
        ...
        table, key_fields, header, duplicate_rows = table_ops.read_table_sect_and_req_key(
            "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/a1_working_12/cdd_12_todo_created.tsv")
        new_table = table_ops.remove_keys(table, key_fields, keys_to_filter_by)

        table_ops.write_table(
            "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/a1_working_12/cdd_12_todo_filtered_by_done_already_im_11.tsv",
            new_table, header)

    def test_read_table_sect_and_req_key(self):
        input_table = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/test/input/FILTERED_TABLE_TO_SEARCH.csv"
    ...
    def test_read_table_sect_and_req_key_no_req(self):
        input_table = "/home/gpoor/PycharmProjects/parse-cdd-docs-to-table/X_a1_working/Working copy of CDD_CTS, CTS-V Annotation Tracker(8.1_9_10_11) go_cdd-cts-tracker - Undon.csv"
        table, key_fields, header, duplicate_rows = table_ops.read_table_sect_and_req_key(file_name=input_table,
                                                                                          logging=True)
        table_ops.write_table(
