...
def do_cdd_html_to_cts_create_sheets(created_table_file=static_data.WORKING_ROOT + "output/created_table.csv",
...
def create_full_table_from_cdd(output_file: str = "output/full_cdd.csv",
